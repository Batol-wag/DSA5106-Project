...
3. ResNet34
   - A larger residual network used by the latest baseline sweep
...
def create_resnet34(num_classes: int = 10) -> nn.Module:
    """
    Create a ResNet-34 model for CIFAR-10 classification.
    """
